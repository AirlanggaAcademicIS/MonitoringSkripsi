...
<div class="form-group">
  <label>Tanggal </label>
   <input type="date" class="form-control" name="TanggalTopik" value="<?php if ($type=="EDIT"){echo $skripsi[0]->TanggalTopik;};?>"> 
</div>
  
<div class="form-group">
  <label>Tahun Ajar </label>
   <input class="form-control" name="TahunAjar" value="<?php if ($type=="EDIT"){echo $skripsi[0]->TahunAjar;};?>">
</div>
 
<div class="form-group">
     <label for="NIM">NIM</label>
      <input class="form-control" name="NIM"  value="<?php if ($type=="EDIT"){echo $skripsi[0]->NIM;};?>">
...
<label>KBK</label>
<div class="">
<Input name="KBK" class="form-control" id="KBK" value="<?php if ($type=="EDIT"){echo $skripsi[0]->KBK;};?>">  
...
<div class="form-group">
<label>Topik</label>
 <Input class="form-control" name="Topik" value="<?php if ($type=="EDIT"){echo $skripsi[0]->Topik;};?>">
</div>      
	
<div class="form-group">
  <label>Judul</label>
  <Input class="form-control" name="Judul" value="<?php if ($type=="EDIT"){echo $skripsi[0]->Judul;};?>">
</div>      
                    
<div class="form-group">
<label>Dosen Pembimbing 1</label>
<div class="">
<Input name="NIK1" class="form-control" id="NIK1" value="<?php if ($type=="EDIT"){echo $skripsi[0]->NIK1;};?>">  
...
<div class="">
<Input name="NIK2" class="form-control" id="NIK2" value="<?php if ($type=="EDIT"){echo $skripsi[0]->NIK2;};?>">  
